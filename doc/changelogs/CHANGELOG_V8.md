...
* [[`efd953c586`](https://github.com/nodejs/node/commit/efd953c586)] - fix --prof-process --preprocess flag (davidmarkclements) [#14966](https://github.com/nodejs/node/pull/14966)
* [[`e9efe44a1f`](https://github.com/nodejs/node/commit/e9efe44a1f)] - **assert**: handle errors properly with deep*Equal (Ruben Bridgewater) [#15001](https://github.com/nodejs/node/pull/15001)
* [[`ff891d4409`](https://github.com/nodejs/node/commit/ff891d4409)] - **assert**: handle sparse arrays in deepStrictEqual (Ruben Bridgewater) [#15027](https://github.com/nodejs/node/pull/15027)
* [[`02020ef785`](https://github.com/nodejs/node/commit/02020ef785)] - **async_hooks**: don't abort unnecessarily (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`65d982c2f5`](https://github.com/nodejs/node/commit/65d982c2f5)] - **async_hooks**: improve comments and function names (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`44a5e61308`](https://github.com/nodejs/node/commit/44a5e61308)] - **async_hooks**: emitAfter correctly on fatalException (Trevor Norris) [#14914](https://github.com/nodejs/node/pull/14914)
* [[`bf40f9d9e2`](https://github.com/nodejs/node/commit/bf40f9d9e2)] - **async_wrap**: unroll unnecessarily DRY code (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`319913a91d`](https://github.com/nodejs/node/commit/319913a91d)] - **async_wrap**: return undefined if domain is disposed (Trevor Norris) [#14722](https://github.com/nodejs/node/pull/14722)
* [[`09e2d59d8e`](https://github.com/nodejs/node/commit/09e2d59d8e)] - **benchmark**: add default configs to buffer benchmark (Rich Trott) [#15175](https://github.com/nodejs/node/pull/15175)
* [[`841abf4c07`](https://github.com/nodejs/node/commit/841abf4c07)] - **benchmark**: fix issues in dns benchmark (Ian Perkins) [#14936](https://github.com/nodejs/node/pull/14936)
* [[`aeb74aff68`](https://github.com/nodejs/node/commit/aeb74aff68)] - **benchmark**: fix dgram/bind-params.js benchmark (Rich Trott) [#14948](https://github.com/nodejs/node/pull/14948)
* [[`45aa860598`](https://github.com/nodejs/node/commit/45aa860598)] - **benchmark**: removed unused arguments from callbacks (Abhishek Raj) [#14919](https://github.com/nodejs/node/pull/14919)
* [[`2cd0487e15`](https://github.com/nodejs/node/commit/2cd0487e15)] - **benchmark**: convert var to es6 const (Sebastian Murphy) [#12886](https://github.com/nodejs/node/pull/12886)
* [[`9f4e835234`](https://github.com/nodejs/node/commit/9f4e835234)] - **buffer**: fix MAX_LENGTH constant export (Anna Henningsen) [#14821](https://github.com/nodejs/node/pull/14821)
* [[`616c3cf000`](https://github.com/nodejs/node/commit/616c3cf000)] - **buffer**: increase coverage by removing dead code (Marcelo Gobelli) [#15100](https://github.com/nodejs/node/pull/15100)
* [[`daa8cd1ce0`](https://github.com/nodejs/node/commit/daa8cd1ce0)] - **build**: display HTTP2 configure --help options (Daniel Bevenius) [#15198](https://github.com/nodejs/node/pull/15198)
* [[`cb41e90e69`](https://github.com/nodejs/node/commit/cb41e90e69)] - **build**: add NetBSD support to opensslconf.h (Roy Marples) [#14313](https://github.com/nodejs/node/pull/14313)
* [[`2e6f745f96`](https://github.com/nodejs/node/commit/2e6f745f96)] - **build**: add npx to zip and 7z packages (Richard Lau) [#15033](https://github.com/nodejs/node/pull/15033)
* [[`c2cbf8c148`](https://github.com/nodejs/node/commit/c2cbf8c148)] - **build**: fix indentation in node.gyp (Alexey Orlenko) [#15051](https://github.com/nodejs/node/pull/15051)
* [[`114f9b2984`](https://github.com/nodejs/node/commit/114f9b2984)] - **build**: for --enable-static, run only cctest (Daniel Bevenius) [#14892](https://github.com/nodejs/node/pull/14892)
* [[`88bd91f66a`](https://github.com/nodejs/node/commit/88bd91f66a)] - **build**: better support for python3 systems (Ben Noordhuis) [#14737](https://github.com/nodejs/node/pull/14737)
* [[`f1f15170b0`](https://github.com/nodejs/node/commit/f1f15170b0)] - **build**: allow proper generation of html docs (Jon Moss) [#14932](https://github.com/nodejs/node/pull/14932)
* [[`64d0b13b1c`](https://github.com/nodejs/node/commit/64d0b13b1c)] - **build**: don't add libraries when --enable-static (Daniel Bevenius) [#14912](https://github.com/nodejs/node/pull/14912)
* [[`ab6b71ec9e`](https://github.com/nodejs/node/commit/ab6b71ec9e)] - **build**: remove duplicated code (Ruslan Bekenev) [#13482](https://github.com/nodejs/node/pull/13482)
...
* [[`028fe88bdf`](https://github.com/nodejs/node/commit/028fe88bdf)] - **console**: improve console.group() (Rich Trott) [#14999](https://github.com/nodejs/node/pull/14999)
* [[`08332ccbd1`](https://github.com/nodejs/node/commit/08332ccbd1)] - **(SEMVER-MINOR)** **console**: implement minimal `console.group()` (Rich Trott) [#14910](https://github.com/nodejs/node/pull/14910)
* [[`c0033c4fd3`](https://github.com/nodejs/node/commit/c0033c4fd3)] - **crypto**: fix error of createCipher in wrap mode (Shigeki Ohtsu) [#15037](https://github.com/nodejs/node/pull/15037)
* [[`b5dd0e891c`](https://github.com/nodejs/node/commit/b5dd0e891c)] - **crypto**: warn if counter mode used in createCipher (Shigeki Ohtsu) [#13821](https://github.com/nodejs/node/pull/13821)
* [[`15c52619a9`](https://github.com/nodejs/node/commit/15c52619a9)] - **deps**: cherry-pick 5005faed5 from V8 upstream (Miguel Martins) [#15177](https://github.com/nodejs/node/pull/15177)
* [[`e246df1837`](https://github.com/nodejs/node/commit/e246df1837)] - **deps**: cherry-pick 1aead19 from upstream V8 (Ben Noordhuis) [#15184](https://github.com/nodejs/node/pull/15184)
* [[`a9cfdea267`](https://github.com/nodejs/node/commit/a9cfdea267)] - **deps**: upgrade libuv to 1.14.1 (cjihrig) [#14866](https://github.com/nodejs/node/pull/14866)
* [[`02befa1dac`](https://github.com/nodejs/node/commit/02befa1dac)] - **deps**: cherry-pick 0ef4a0c64b6 from c-ares upstream (Anna Henningsen) [#15023](https://github.com/nodejs/node/pull/15023)
* [[`c5018537fc`](https://github.com/nodejs/node/commit/c5018537fc)] - **deps**: cherry-pick e020aae394 from V8 upstream (Ben Noordhuis) [#14913](https://github.com/nodejs/node/pull/14913)
* [[`1701c7f000`](https://github.com/nodejs/node/commit/1701c7f000)] - **deps**: fixup nghttp2 version number (Anna Henningsen) [#14955](https://github.com/nodejs/node/pull/14955)
* [[`7bf009c6e3`](https://github.com/nodejs/node/commit/7bf009c6e3)] - **deps**: update nghttp2 to v1.25.0 (Anna Henningsen) [#14955](https://github.com/nodejs/node/pull/14955)
* [[`25597fa1de`](https://github.com/nodejs/node/commit/25597fa1de)] - **deps**: backport d727680 from V8 upstream (Matt Loring) [#14947](https://github.com/nodejs/node/pull/14947)
* [[`87c8d02172`](https://github.com/nodejs/node/commit/87c8d02172)] - **deps**: cherry-pick eb306f463e from nghttp2 upstream (Anna Henningsen) [#14808](https://github.com/nodejs/node/pull/14808)
* [[`e8be089e33`](https://github.com/nodejs/node/commit/e8be089e33)] - **deps**: backport f9c4b7a from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`38bd53a37e`](https://github.com/nodejs/node/commit/38bd53a37e)] - **deps**: backport bca8409 from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`e12e419b0e`](https://github.com/nodejs/node/commit/e12e419b0e)] - **deps**: backport 6e9e2e5 from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`9ac4fbaf97`](https://github.com/nodejs/node/commit/9ac4fbaf97)] - **deps**: backport 3d8e87a from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`39ab763e83`](https://github.com/nodejs/node/commit/39ab763e83)] - **deps**: backport 5152d97 from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`a5fd766709`](https://github.com/nodejs/node/commit/a5fd766709)] - **deps**: backport c4852ea from upstream V8 (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`a19221e60b`](https://github.com/nodejs/node/commit/a19221e60b)] - **deps**: cherry-pick fa4ec9f from V8 upstream (Jaideep Bajwa) [#14608](https://github.com/nodejs/node/pull/14608)
* [[`79958975cc`](https://github.com/nodejs/node/commit/79958975cc)] - **deps**: fix inspector v8 test (Eugene Ostroukhov) [#14827](https://github.com/nodejs/node/pull/14827)
* [[`c29091e288`](https://github.com/nodejs/node/commit/c29091e288)] - **dns**: add `verbatim` option to dns.lookup() (Ben Noordhuis) [#14731](https://github.com/nodejs/node/pull/14731)
* [[`76e1cb9eae`](https://github.com/nodejs/node/commit/76e1cb9eae)] - **doc**: add ESM doc to _toc.md and all.md (Vse Mozhet Byt) [#15248](https://github.com/nodejs/node/pull/15248)
* [[`71657d8b11`](https://github.com/nodejs/node/commit/71657d8b11)] - **doc**: fix Error property markdown level (Sam Roberts) [#15247](https://github.com/nodejs/node/pull/15247)
* [[`350ce24d4c`](https://github.com/nodejs/node/commit/350ce24d4c)] - **doc**: add missing space in test/README.md (Vse Mozhet Byt) [#15278](https://github.com/nodejs/node/pull/15278)
* [[`0814a718ed`](https://github.com/nodejs/node/commit/0814a718ed)] - **doc**: document bytes to chars after setEncoding (Jessica Quynh Tran) [#13442](https://github.com/nodejs/node/pull/13442)
* [[`d66a4ebfda`](https://github.com/nodejs/node/commit/d66a4ebfda)] - **doc**: describe what security issues are (Sam Roberts) [#14485](https://github.com/nodejs/node/pull/14485)
* [[`9d90e93d57`](https://github.com/nodejs/node/commit/9d90e93d57)] - **doc**: add options argument to crypto docs (Adina Shanholtz) [#14846](https://github.com/nodejs/node/pull/14846)
* [[`53d53cf22a`](https://github.com/nodejs/node/commit/53d53cf22a)] - **doc**: instructions for generating coverage reports (Simon Brewster) [#15190](https://github.com/nodejs/node/pull/15190)
* [[`8cbec3be47`](https://github.com/nodejs/node/commit/8cbec3be47)] - **doc**: clarify async/asynchronous in deprecations.md (Rich Trott) [#15172](https://github.com/nodejs/node/pull/15172)
* [[`468631bce7`](https://github.com/nodejs/node/commit/468631bce7)] - **doc**: `readFileSync` instead of `fs.readFileSync` (Piotr Mionskowski) [#15137](https://github.com/nodejs/node/pull/15137)
* [[`daaa4f18fe`](https://github.com/nodejs/node/commit/daaa4f18fe)] - **doc**: /s/SHASUM256/SHASUMS256 (Jon Moss) [#15101](https://github.com/nodejs/node/pull/15101)
* [[`3e60a26fe4`](https://github.com/nodejs/node/commit/3e60a26fe4)] - **doc**: fix comment about http2.createSecureServer (creeperyang) [#15085](https://github.com/nodejs/node/pull/15085)
* [[`2aef11409e`](https://github.com/nodejs/node/commit/2aef11409e)] - **doc**: remove braces which shouldn't be there (Jan Schär) [#15094](https://github.com/nodejs/node/pull/15094)
* [[`13332f67e3`](https://github.com/nodejs/node/commit/13332f67e3)] - **doc**: clarify http.get data consumption requirement (AJ Jordan) [#15049](https://github.com/nodejs/node/pull/15049)
* [[`4af4d7de18`](https://github.com/nodejs/node/commit/4af4d7de18)] - **doc**: add 8.4.0 link to CHANGELOG.md (Ruslan Iusupov) [#15064](https://github.com/nodejs/node/pull/15064)
* [[`0458b71338`](https://github.com/nodejs/node/commit/0458b71338)] - **doc**: add links to alternative versions of doc (Chris Young) [#10958](https://github.com/nodejs/node/pull/10958)
* [[`022ce73fde`](https://github.com/nodejs/node/commit/022ce73fde)] - **doc**: update configure to require g++ 4.9.4 (Dave Olszewski) [#14204](https://github.com/nodejs/node/pull/14204)
* [[`00bb4ceb5a`](https://github.com/nodejs/node/commit/00bb4ceb5a)] - **doc**: building - note on Windows SDK 15063 (Refael Ackermann) [#14394](https://github.com/nodejs/node/pull/14394)
* [[`4b44367fe2`](https://github.com/nodejs/node/commit/4b44367fe2)] - **doc**: threadpool size, and APIs using the pool (Sam Roberts) [#14995](https://github.com/nodejs/node/pull/14995)
* [[`ef96730765`](https://github.com/nodejs/node/commit/ef96730765)] - **doc**: sort bottom-of-file dns markdown links (Sam Roberts) [#14992](https://github.com/nodejs/node/pull/14992)
* [[`c02ba7e10d`](https://github.com/nodejs/node/commit/c02ba7e10d)] - **doc**: crypto.randomBytes does not block when async (Sam Roberts) [#14993](https://github.com/nodejs/node/pull/14993)
* [[`6689b74f46`](https://github.com/nodejs/node/commit/6689b74f46)] - **doc**: environmental-\>environment & NodeJS-\>Node.js (Rod Vagg) [#14974](https://github.com/nodejs/node/pull/14974)
* [[`62ed468fa6`](https://github.com/nodejs/node/commit/62ed468fa6)] - **doc**: fix typo in Buffer.from(string, \[encoding\]) (Michał Wadas) [#15013](https://github.com/nodejs/node/pull/15013)
* [[`41db5ffc62`](https://github.com/nodejs/node/commit/41db5ffc62)] - **doc**: add note for Windows build path (Kyle Lamse) [#14354](https://github.com/nodejs/node/pull/14354)
* [[`bf7b79dee1`](https://github.com/nodejs/node/commit/bf7b79dee1)] - **doc**: rephrase text of child_process.execSync() (hafiz) [#14953](https://github.com/nodejs/node/pull/14953)
* [[`13675b3613`](https://github.com/nodejs/node/commit/13675b3613)] - **doc**: beautify net.md formats (sevenryze) [#14987](https://github.com/nodejs/node/pull/14987)
* [[`7818cd57a9`](https://github.com/nodejs/node/commit/7818cd57a9)] - **doc**: link to correct "OS Constants" heading in docs (James Kyle) [#14969](https://github.com/nodejs/node/pull/14969)
* [[`d1e170cb88`](https://github.com/nodejs/node/commit/d1e170cb88)] - **doc**: remove misterdjules from the CTC members list (Julien Gilli) [#1498](https://github.com/nodejs/node/pull/1498)
* [[`309499089f`](https://github.com/nodejs/node/commit/309499089f)] - **doc**: update http2.md example code (RefinedSoftwareLLC) [#14979](https://github.com/nodejs/node/pull/14979)
* [[`689bf8a46d`](https://github.com/nodejs/node/commit/689bf8a46d)] - **doc**: fix doc for napi_get_value_string_utf8 (Daniel Taveras) [#14529](https://github.com/nodejs/node/pull/14529)
* [[`2494ca2d7a`](https://github.com/nodejs/node/commit/2494ca2d7a)] - **doc**: fixed link definitions in http2.md footer (sharababy) [#14946](https://github.com/nodejs/node/pull/14946)
* [[`c2121d55cc`](https://github.com/nodejs/node/commit/c2121d55cc)] - **doc**: remove `you` and fixup note in stream.md (James M Snell) [#14938](https://github.com/nodejs/node/pull/14938)
* [[`69440c95fe`](https://github.com/nodejs/node/commit/69440c95fe)] - **doc**: minor fixes to http/2 docs (Anand Suresh) [#14877](https://github.com/nodejs/node/pull/14877)
* [[`1230c1de0b`](https://github.com/nodejs/node/commit/1230c1de0b)] - **doc**: remove redundant only from doc/api/stream.md (George Sapkin) [#14858](https://github.com/nodejs/node/pull/14858)
* [[`1a4fd677e8`](https://github.com/nodejs/node/commit/1a4fd677e8)] - **doc**: add missing word (Jon Moss) [#14924](https://github.com/nodejs/node/pull/14924)
* [[`639e8d49eb`](https://github.com/nodejs/node/commit/639e8d49eb)] - **doc**: fix http api document (陈刚) [#14625](https://github.com/nodejs/node/pull/14625)
* [[`356a72aed1`](https://github.com/nodejs/node/commit/356a72aed1)] - **doc**: explain what to do if git push is rejected (Rich Trott) [#14848](https://github.com/nodejs/node/pull/14848)
* [[`2b1a409842`](https://github.com/nodejs/node/commit/2b1a409842)] - **doc**: add BridgeAR to collaborators (Ruben Bridgewater) [#14862](https://github.com/nodejs/node/pull/14862)
* [[`e09138eca7`](https://github.com/nodejs/node/commit/e09138eca7)] - **doc**: fix typo in cli.md (hsmtkk) [#14855](https://github.com/nodejs/node/pull/14855)
* [[`2f87de95bf`](https://github.com/nodejs/node/commit/2f87de95bf)] - **doc**: added napi_get_value_string_latin1 (Kyle Farnung) [#14678](https://github.com/nodejs/node/pull/14678)
* [[`c1ba02748f`](https://github.com/nodejs/node/commit/c1ba02748f)] - **doc**: fix word wrapping for api stability boxes (Saad Quadri) [#14809](https://github.com/nodejs/node/pull/14809)
* [[`6f35729909`](https://github.com/nodejs/node/commit/6f35729909)] - **doc,fs**: rename defaultEncoding option to encoding (Aleh Zasypkin) [#14867](https://github.com/nodejs/node/pull/14867)
* [[`eb30cbcbff`](https://github.com/nodejs/node/commit/eb30cbcbff)] - **doc,lib,src,test**: strip executable bits off files (Anna Henningsen) [#15132](https://github.com/nodejs/node/pull/15132)
* [[`2dbaa748e5`](https://github.com/nodejs/node/commit/2dbaa748e5)] - **doc,stream**: remove wrong remark on readable.read (Jan Schär) [#15014](https://github.com/nodejs/node/pull/15014)
* [[`7018405978`](https://github.com/nodejs/node/commit/7018405978)] - **errors**: remove duplicated ERR_HTTP_INVALID_STATUS_CODE error (Jon Moss) [#15003](https://github.com/nodejs/node/pull/15003)
* [[`f0b13a132b`](https://github.com/nodejs/node/commit/f0b13a132b)] - **(SEMVER-MINOR)** **fs**: add fs.copyFile{Sync} (cjihrig) [#15034](https://github.com/nodejs/node/pull/15034)
* [[`0161dc1997`](https://github.com/nodejs/node/commit/0161dc1997)] - **gyp**: fix ninja build failure (GYP patch) (Daniel Bevenius) [#12484](https://github.com/nodejs/node/pull/12484)
* [[`2125f7e2b0`](https://github.com/nodejs/node/commit/2125f7e2b0)] - **gyp**: enable cctest to use objects (gyp part) (Daniel Bevenius) [#12450](https://github.com/nodejs/node/pull/12450)
* [[`8ddd0a5af5`](https://github.com/nodejs/node/commit/8ddd0a5af5)] - **gyp**: add compile_commands.json gyp generator (Ben Noordhuis) [#12450](https://github.com/nodejs/node/pull/12450)
* [[`1fe09e145a`](https://github.com/nodejs/node/commit/1fe09e145a)] - **gyp**: inherit parent for `*.host` (Johan Bergström) [#6173](https://github.com/nodejs/node/pull/6173)
* [[`d05f19dd8f`](https://github.com/nodejs/node/commit/d05f19dd8f)] - **gyp**: fix gyp to work on MacOSX without XCode (Shigeki Ohtsu) [iojs/io.js#1325](https://github.com/iojs/io.js/pull/1325)
* [[`a5b6677aee`](https://github.com/nodejs/node/commit/a5b6677aee)] - **http2**: set decodeStrings to false, test (Anatoli Papirovski) [#15140](https://github.com/nodejs/node/pull/15140)
* [[`f8e5d59f8e`](https://github.com/nodejs/node/commit/f8e5d59f8e)] - **http2**: use session not socket timeout, tests (Anatoli Papirovski) [#15188](https://github.com/nodejs/node/pull/15188)
* [[`09ddb5a435`](https://github.com/nodejs/node/commit/09ddb5a435)] - **http2**: add compat trailers, adjust multi-headers (Anatoli Papirovski) [#15193](https://github.com/nodejs/node/pull/15193)
* [[`f34446ab6f`](https://github.com/nodejs/node/commit/f34446ab6f)] - **http2**: fix closedCode NaN, increase test coverage (Anatoli Papirovski) [#15154](https://github.com/nodejs/node/pull/15154)
* [[`0146a545d7`](https://github.com/nodejs/node/commit/0146a545d7)] - **http2**: guard against destroyed session, timeouts (James M Snell) [#15106](https://github.com/nodejs/node/pull/15106)
* [[`886612ff14`](https://github.com/nodejs/node/commit/886612ff14)] - **http2**: correct emit error in onConnect, full tests (Anatoli Papirovski) [#15080](https://github.com/nodejs/node/pull/15080)
* [[`e4f8c55220`](https://github.com/nodejs/node/commit/e4f8c55220)] - **http2**: adjust error types, test coverage (Anatoli Papirovski) [#15109](https://github.com/nodejs/node/pull/15109)
* [[`e8b7677627`](https://github.com/nodejs/node/commit/e8b7677627)] - **http2**: handle 100-continue flow & writeContinue (Anatoli Papirovski) [#15039](https://github.com/nodejs/node/pull/15039)
* [[`e1b267b6b5`](https://github.com/nodejs/node/commit/e1b267b6b5)] - **http2**: refactor error handling (Matteo Collina) [#14991](https://github.com/nodejs/node/pull/14991)
* [[`490917d423`](https://github.com/nodejs/node/commit/490917d423)] - **http2**: ignore invalid headers explicitly (Anna Henningsen) [#14955](https://github.com/nodejs/node/pull/14955)
* [[`cd120bb694`](https://github.com/nodejs/node/commit/cd120bb694)] - **http2**: minor refactor of passing headers to JS (Anna Henningsen) [#14808](https://github.com/nodejs/node/pull/14808)
* [[`b7c92a5236`](https://github.com/nodejs/node/commit/b7c92a5236)] - **http2**: handful of http/2 src cleanups (James M Snell) [#14825](https://github.com/nodejs/node/pull/14825)
* [[`df592b2e18`](https://github.com/nodejs/node/commit/df592b2e18)] - **http2**: Expose Http2ServerRequest/Response (Pini Houri) [#14690](https://github.com/nodejs/node/pull/14690)
* [[`98362542ee`](https://github.com/nodejs/node/commit/98362542ee)] - **(SEMVER-MINOR)** **inspector**: enable async stack traces (Miroslav Bajtoš) [#13870](https://github.com/nodejs/node/pull/13870)
* [[`82823f7821`](https://github.com/nodejs/node/commit/82823f7821)] - **inspector**: rewrite inspector test helper (Eugene Ostroukhov) [#14797](https://github.com/nodejs/node/pull/14797)
* [[`a81a0f4e79`](https://github.com/nodejs/node/commit/a81a0f4e79)] - **inspector**: log exceptions in message handlers (Eugene Ostroukhov) [#14980](https://github.com/nodejs/node/pull/14980)
* [[`0a22d0d137`](https://github.com/nodejs/node/commit/0a22d0d137)] - **lib**: remove circular reference (Ruben Bridgewater) [#14885](https://github.com/nodejs/node/pull/14885)
* [[`9c11f33212`](https://github.com/nodejs/node/commit/9c11f33212)] - **lib**: simplify the readonly properties of icu (Jackson Tian) [#13221](https://github.com/nodejs/node/pull/13221)
* [[`2ba9ca2e50`](https://github.com/nodejs/node/commit/2ba9ca2e50)] - **lib**: remove the invalid command line options (Jackson Tian) [#13764](https://github.com/nodejs/node/pull/13764)
* [[`1aa87bb510`](https://github.com/nodejs/node/commit/1aa87bb510)] - **lib**: clean up usage of threw (Jackson Tian) [#10534](https://github.com/nodejs/node/pull/10534)
* [[`a10c13b947`](https://github.com/nodejs/node/commit/a10c13b947)] - **lib**: instantiate console methods eagerly (Ben Noordhuis) [#14791](https://github.com/nodejs/node/pull/14791)
* [[`e99b95b5f8`](https://github.com/nodejs/node/commit/e99b95b5f8)] - **meta**: merge TSC and CTC back into a single body (James M Snell) [#14973](https://github.com/nodejs/node/pull/14973)
* [[`3a32448cb9`](https://github.com/nodejs/node/commit/3a32448cb9)] - **meta**: considerations for new core modules (James M Snell) [#15022](https://github.com/nodejs/node/pull/15022)
* [[`74ec5339d8`](https://github.com/nodejs/node/commit/74ec5339d8)] - **meta**: improve definition of a collaborator (James M Snell) [#14981](https://github.com/nodejs/node/pull/14981)
* [[`7a8d350ac9`](https://github.com/nodejs/node/commit/7a8d350ac9)] - **(SEMVER-MINOR)** **module**: Allow runMain to be ESM (Bradley Farias) [#14369](https://github.com/nodejs/node/pull/14369)
* [[`342d526e1f`](https://github.com/nodejs/node/commit/342d526e1f)] - **n-api**: implement napi_run_script (Gabriel Schulhof) [#15216](https://github.com/nodejs/node/pull/15216)
* [[`f0400d36e8`](https://github.com/nodejs/node/commit/f0400d36e8)] - **n-api**: adds function to adjust external memory (Chris Young) [#14310](https://github.com/nodejs/node/pull/14310)
* [[`6d09456692`](https://github.com/nodejs/node/commit/6d09456692)] - **(SEMVER-MINOR)** **n-api**: implement promise (Gabriel Schulhof) [#14365](https://github.com/nodejs/node/pull/14365)
* [[`530ff99a50`](https://github.com/nodejs/node/commit/530ff99a50)] - **(SEMVER-MINOR)** **n-api**: add ability to remove a wrapping (Gabriel Schulhof) [#14658](https://github.com/nodejs/node/pull/14658)
* [[`1d36b91bc9`](https://github.com/nodejs/node/commit/1d36b91bc9)] - **net**: check EADDRINUSE after binding localPort (Joyee Cheung) [#15097](https://github.com/nodejs/node/pull/15097)
* [[`4dbf6aca67`](https://github.com/nodejs/node/commit/4dbf6aca67)] - **net**: move debug statement (Brian White) [#12616](https://github.com/nodejs/node/pull/12616)
...
* [[`bee6a5e786`](https://github.com/nodejs/node/commit/bee6a5e786)] - **path**: fix normalize on directories with two dots (Michaël Zasso) [#14107](https://github.com/nodejs/node/pull/14107)
* [[`0d8cba31c3`](https://github.com/nodejs/node/commit/0d8cba31c3)] - **perf_hooks**: fix presumed typo in node_perf.cc (Anna Henningsen) [#15019](https://github.com/nodejs/node/pull/15019)
* [[`e555bb839f`](https://github.com/nodejs/node/commit/e555bb839f)] - **perf_hooks**: mark as experimental (James M Snell) [#14997](https://github.com/nodejs/node/pull/14997)
* [[`0258f45922`](https://github.com/nodejs/node/commit/0258f45922)] - **(SEMVER-MINOR)** **perf_hooks**: implementation of the perf timing API (James M Snell) [#14680](https://github.com/nodejs/node/pull/14680)
...
* [[`ce076cc5a4`](https://github.com/nodejs/node/commit/ce076cc5a4)] - **promises**: more robust stringification (Timothy Gu) [#13784](https://github.com/nodejs/node/pull/13784)
* [[`53e0af4158`](https://github.com/nodejs/node/commit/53e0af4158)] - **repl**: force editorMode in .load (Lance Ball) [#14861](https://github.com/nodejs/node/pull/14861)
* [[`59aec29af4`](https://github.com/nodejs/node/commit/59aec29af4)] - **src**: turn key length exception into CHECK (Ben Noordhuis) [#15183](https://github.com/nodejs/node/pull/15183)
* [[`78be754c77`](https://github.com/nodejs/node/commit/78be754c77)] - **src**: fix compiler warnings in node_perf.cc (Daniel Bevenius) [#15112](https://github.com/nodejs/node/pull/15112)
* [[`46b33a392b`](https://github.com/nodejs/node/commit/46b33a392b)] - **src**: remove unused persistent properties from env (Anna Henningsen) [#15096](https://github.com/nodejs/node/pull/15096)
* [[`f5b3b2b45a`](https://github.com/nodejs/node/commit/f5b3b2b45a)] - **src**: fix build on certain platforms (Anna Henningsen) [#14996](https://github.com/nodejs/node/pull/14996)
* [[`12245ae620`](https://github.com/nodejs/node/commit/12245ae620)] - **src**: reduce code duplication (James M Snell) [#14937](https://github.com/nodejs/node/pull/14937)
* [[`9b9932a0d9`](https://github.com/nodejs/node/commit/9b9932a0d9)] - **src**: fixup strings, reduce duplication (James M Snell) [#14937](https://github.com/nodejs/node/pull/14937)
* [[`e40bde6bbd`](https://github.com/nodejs/node/commit/e40bde6bbd)] - **src**: miscellaneous cleanups for node_config (James M Snell) [#14868](https://github.com/nodejs/node/pull/14868)
* [[`2881911c8c`](https://github.com/nodejs/node/commit/2881911c8c)] - **src**: fix DEBUG_HTTP2 type arguments (Daniel Bevenius) [#15197](https://github.com/nodejs/node/pull/15197)
* [[`32c5c261b5`](https://github.com/nodejs/node/commit/32c5c261b5)] - **src**: replace assert() with CHECK() (Ben Noordhuis) [#14663](https://github.com/nodejs/node/pull/14663)
* [[`4969a69210`](https://github.com/nodejs/node/commit/4969a69210)] - **src**: remove unnecessary helper function (Brian White) [#14959](https://github.com/nodejs/node/pull/14959)
* [[`787d563e2d`](https://github.com/nodejs/node/commit/787d563e2d)] - **src**: detect nul bytes in InternalModuleReadFile() (Ben Noordhuis) [#14854](https://github.com/nodejs/node/pull/14854)
* [[`e6965f048b`](https://github.com/nodejs/node/commit/e6965f048b)] - **src**: remove extra copy from Copy() in node_url.cc (Anna Henningsen) [#14907](https://github.com/nodejs/node/pull/14907)
* [[`6326d20b4c`](https://github.com/nodejs/node/commit/6326d20b4c)] - **src**: minor cleanup for node_revert (James M Snell) [#14864](https://github.com/nodejs/node/pull/14864)
* [[`94f34ca2c6`](https://github.com/nodejs/node/commit/94f34ca2c6)] - **src**: use `unordered_set` instead of custom rb tree (Anna Henningsen) [#14826](https://github.com/nodejs/node/pull/14826)
* [[`7d0d59d49f`](https://github.com/nodejs/node/commit/7d0d59d49f)] - **src**: Node implementation of v8::Platform (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`0b6a8530c6`](https://github.com/nodejs/node/commit/0b6a8530c6)] - **stream**: fix Writable instanceof for subclasses (Anna Henningsen) [#14945](https://github.com/nodejs/node/pull/14945)
* [[`df1f462737`](https://github.com/nodejs/node/commit/df1f462737)] - **test**: split test-cli-node-options (Refael Ackermann) [#14195](https://github.com/nodejs/node/pull/14195)
* [[`b25156e8d6`](https://github.com/nodejs/node/commit/b25156e8d6)] - **test**: remove envPlus, use Object.assign everywhere (Gibson Fahnestock) [#14845](https://github.com/nodejs/node/pull/14845)
* [[`a1dc29de03`](https://github.com/nodejs/node/commit/a1dc29de03)] - **test**: fix flaky test-readline-interface (Rich Trott) [#15066](https://github.com/nodejs/node/pull/15066)
* [[`4800ab57ff`](https://github.com/nodejs/node/commit/4800ab57ff)] - **test**: continue normalizing fixtures use (Miguel Angel Asencio Hurtado) [#14716](https://github.com/nodejs/node/pull/14716)
* [[`e0dccd059d`](https://github.com/nodejs/node/commit/e0dccd059d)] - **(SEMVER-MINOR)** **test**: fix inspector helper port sniffing (Timothy Gu) [#13870](https://github.com/nodejs/node/pull/13870)
* [[`ff1b64a1e9`](https://github.com/nodejs/node/commit/ff1b64a1e9)] - **test**: preserve env in test cases (Beth Griggs) [#14822](https://github.com/nodejs/node/pull/14822)
* [[`d4d8da9255`](https://github.com/nodejs/node/commit/d4d8da9255)] - **test**: exclude write-coverage from coverage report (Benjamin Coe) [#15194](https://github.com/nodejs/node/pull/15194)
* [[`ed81497e86`](https://github.com/nodejs/node/commit/ed81497e86)] - **test**: use no-save and no-package-lock flags (Simon Brewster) [#15196](https://github.com/nodejs/node/pull/15196)
* [[`56222241af`](https://github.com/nodejs/node/commit/56222241af)] - **test**: add http2 compat setTimeout tests (Anatoli Papirovski) [#15156](https://github.com/nodejs/node/pull/15156)
* [[`7078c2f653`](https://github.com/nodejs/node/commit/7078c2f653)] - **test**: add test-benchmark-buffer (Rich Trott) [#15175](https://github.com/nodejs/node/pull/15175)
* [[`e8bbcef69a`](https://github.com/nodejs/node/commit/e8bbcef69a)] - **test**: refactor test-fs-readfile-unlink (Rich Trott) [#15173](https://github.com/nodejs/node/pull/15173)
* [[`a14c50049e`](https://github.com/nodejs/node/commit/a14c50049e)] - **test**: http2 test coverage for NghttpError (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`a3aac48b75`](https://github.com/nodejs/node/commit/a3aac48b75)] - **test**: http2 test coverage for assertValidPseudoHeader (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`1987967a15`](https://github.com/nodejs/node/commit/1987967a15)] - **test**: http2 test coverage for updateOptionsBuffer (James M Snell) [#15105](https://github.com/nodejs/node/pull/15105)
* [[`09f9d00eef`](https://github.com/nodejs/node/commit/09f9d00eef)] - **test**: increase Http2ServerResponse test coverage (Anatoli Papirovski) [#15074](https://github.com/nodejs/node/pull/15074)
* [[`00e387fb79`](https://github.com/nodejs/node/commit/00e387fb79)] - **test**: split path tests into multiple files (Michaël Zasso) [#15093](https://github.com/nodejs/node/pull/15093)
* [[`b3267a3c87`](https://github.com/nodejs/node/commit/b3267a3c87)] - **test**: add a test for Expect & checkExpectation (Anatoli Papirovski) [#15040](https://github.com/nodejs/node/pull/15040)
* [[`7c6bcfc94e`](https://github.com/nodejs/node/commit/7c6bcfc94e)] - **test**: add http2 test for method CONNECT (Anatoli Papirovski) [#15052](https://github.com/nodejs/node/pull/15052)
* [[`fa85f83f61`](https://github.com/nodejs/node/commit/fa85f83f61)] - **test**: remove unused param in test-graph.pipe (Simon Brewster) [#15007](https://github.com/nodejs/node/pull/15007)
* [[`ec717a1d0d`](https://github.com/nodejs/node/commit/ec717a1d0d)] - **test**: increase coverage for http2 response headers (Anatoli Papirovski) [#15035](https://github.com/nodejs/node/pull/15035)
* [[`e7e1b2a430`](https://github.com/nodejs/node/commit/e7e1b2a430)] - **test**: fix hijackStdout behavior in console (XadillaX) [#14647](https://github.com/nodejs/node/pull/14647)
* [[`5e910a627b`](https://github.com/nodejs/node/commit/5e910a627b)] - **test**: add regression test for 14814 (Anna Henningsen) [#15023](https://github.com/nodejs/node/pull/15023)
* [[`7186f1c453`](https://github.com/nodejs/node/commit/7186f1c453)] - **test**: run abort tests (Rich Trott) [#14013](https://github.com/nodejs/node/pull/14013)
* [[`283c6bea0b`](https://github.com/nodejs/node/commit/283c6bea0b)] - **test**: improve test-abort-backtrace (Rich Trott) [#14013](https://github.com/nodejs/node/pull/14013)
* [[`fc89220fee`](https://github.com/nodejs/node/commit/fc89220fee)] - **test**: improve test-abort-uncaught-exception (Rich Trott) [#14013](https://github.com/nodejs/node/pull/14013)
* [[`440f2fc08a`](https://github.com/nodejs/node/commit/440f2fc08a)] - **test**: pipe some error output if npm fails (Jeremiah Senkpiel) [#12490](https://github.com/nodejs/node/pull/12490)
* [[`dc0d2d6106`](https://github.com/nodejs/node/commit/dc0d2d6106)] - **test**: simplify test-tls-client-default-ciphers (Jon Moss) [#14928](https://github.com/nodejs/node/pull/14928)
* [[`be2c7119cc`](https://github.com/nodejs/node/commit/be2c7119cc)] - **test**: remove unused function args (Mohd Maqbool Alam) [#14971](https://github.com/nodejs/node/pull/14971)
* [[`fc8eb0a515`](https://github.com/nodejs/node/commit/fc8eb0a515)] - **test**: extend async addon test (Anna Henningsen) [#14922](https://github.com/nodejs/node/pull/14922)
* [[`bf85dd535d`](https://github.com/nodejs/node/commit/bf85dd535d)] - **test**: fix async-hooks tests (Bartosz Sosnowski) [#14865](https://github.com/nodejs/node/pull/14865)
* [[`25d56ad201`](https://github.com/nodejs/node/commit/25d56ad201)] - **test**: add test-benchmark-process (Rich Trott) [#14951](https://github.com/nodejs/node/pull/14951)
* [[`ff3793c0c2`](https://github.com/nodejs/node/commit/ff3793c0c2)] - **test**: add test-benchmark-path (Rich Trott) [#14951](https://github.com/nodejs/node/pull/14951)
* [[`b81da629a0`](https://github.com/nodejs/node/commit/b81da629a0)] - **test**: add test-benchmark-os (Rich Trott) [#14951](https://github.com/nodejs/node/pull/14951)
* [[`566c98fabe`](https://github.com/nodejs/node/commit/566c98fabe)] - **test**: add test-benchmark-events (Rich Trott) [#14951](https://github.com/nodejs/node/pull/14951)
* [[`09fadc5823`](https://github.com/nodejs/node/commit/09fadc5823)] - **test**: add test-benchmark-domain (Rich Trott) [#14951](https://github.com/nodejs/node/pull/14951)
* [[`3a399ab590`](https://github.com/nodejs/node/commit/3a399ab590)] - **test**: add known issue for vm module (Franziska Hinkelmann) [#14661](https://github.com/nodejs/node/pull/14661)
* [[`989c239ca8`](https://github.com/nodejs/node/commit/989c239ca8)] - **test**: do not modify fixtures in test-fs-chmod (Rich Trott) [#14926](https://github.com/nodejs/node/pull/14926)
* [[`13c8c52492`](https://github.com/nodejs/node/commit/13c8c52492)] - **test**: improve assertion fail messages (Refael Ackermann) [#14949](https://github.com/nodejs/node/pull/14949)
* [[`94b850f165`](https://github.com/nodejs/node/commit/94b850f165)] - **test**: remove unused parameters (Daniil Shakir) [#14968](https://github.com/nodejs/node/pull/14968)
* [[`f51c19ce02`](https://github.com/nodejs/node/commit/f51c19ce02)] - **test**: remove unused arguments from function (Ankit Parashar) [#14931](https://github.com/nodejs/node/pull/14931)
* [[`6263e014ec`](https://github.com/nodejs/node/commit/6263e014ec)] - **test**: update windows module load error message (cjihrig) [#14950](https://github.com/nodejs/node/pull/14950)
* [[`764b3c661d`](https://github.com/nodejs/node/commit/764b3c661d)] - **test**: increase coverage for http2.connect (Michael Albert) [#14832](https://github.com/nodejs/node/pull/14832)
* [[`118d662134`](https://github.com/nodejs/node/commit/118d662134)] - **test**: make timers-blocking-callback more reliable (Rich Trott) [#14831](https://github.com/nodejs/node/pull/14831)
* [[`39d5f2f6c2`](https://github.com/nodejs/node/commit/39d5f2f6c2)] - **test**: remove erroneous assert message from test (Beth Griggs) [#14918](https://github.com/nodejs/node/pull/14918)
* [[`e263c02ddd`](https://github.com/nodejs/node/commit/e263c02ddd)] - **test**: add test for cluster benchmarks (Rich Trott) [#14812](https://github.com/nodejs/node/pull/14812)
* [[`03340eb89a`](https://github.com/nodejs/node/commit/03340eb89a)] - **test**: Mark test-stop-profile-after-done flaky (Eugene Ostroukhov) 
* [[`c0e7344dba`](https://github.com/nodejs/node/commit/c0e7344dba)] - **test**: check util.inspect circular Set and Map refs (Ruben Bridgewater) [#14790](https://github.com/nodejs/node/pull/14790)
* [[`8004625daf`](https://github.com/nodejs/node/commit/8004625daf)] - **test**: refactor async-hooks/test-httparser tests (Runite618) [#14818](https://github.com/nodejs/node/pull/14818)
* [[`7ee4aa3a1d`](https://github.com/nodejs/node/commit/7ee4aa3a1d)] - **test**: use reserved invalid hostname for tests (icarter09) [#14781](https://github.com/nodejs/node/pull/14781)
...
* [[`17bd4f624e`](https://github.com/nodejs/node/commit/17bd4f624e)] - **test, win**: fix IPv6 detection on Windows (Bartosz Sosnowski) [#14865](https://github.com/nodejs/node/pull/14865)
* [[`c0705ba1cd`](https://github.com/nodejs/node/commit/c0705ba1cd)] - **test,doc**: make module name match gyp target name (Gabriel Schulhof) [#15209](https://github.com/nodejs/node/pull/15209)
* [[`82017c10c1`](https://github.com/nodejs/node/commit/82017c10c1)] - **timers**: fix outdated comment (Tim Costa) [#14314](https://github.com/nodejs/node/pull/14314)
* [[`1c37c929cc`](https://github.com/nodejs/node/commit/1c37c929cc)] - **(SEMVER-MINOR)** **tls**: multiple PFX in createSecureContext (Yury Popov) [#14793](https://github.com/nodejs/node/pull/14793)
* [[`488a57612f`](https://github.com/nodejs/node/commit/488a57612f)] - **tools**: bump vswhere helper to 2.0.0 (Refael Ackermann) [#14557](https://github.com/nodejs/node/pull/14557)
* [[`25fd56397f`](https://github.com/nodejs/node/commit/25fd56397f)] - **tools**: add eslint rule for inspector checking (Daniel Bevenius) [#13813](https://github.com/nodejs/node/pull/13813)
* [[`b41ee1030e`](https://github.com/nodejs/node/commit/b41ee1030e)] - **tools**: add eslint rule for hasCrypto checking (Daniel Bevenius) [#13813](https://github.com/nodejs/node/pull/13813)
* [[`b293b5ad31`](https://github.com/nodejs/node/commit/b293b5ad31)] - **tools**: fix linter error in html.js (Michaël Zasso) [#15063](https://github.com/nodejs/node/pull/15063)
* [[`5f9c728703`](https://github.com/nodejs/node/commit/5f9c728703)] - **tools**: add custom private key option (Ruslan Bekenev) [#14401](https://github.com/nodejs/node/pull/14401)
* [[`a86e6cfd14`](https://github.com/nodejs/node/commit/a86e6cfd14)] - **tools**: update GYP to 324dd166 (Refael Ackermann) [#14718](https://github.com/nodejs/node/pull/14718)
* [[`abc9a069d4`](https://github.com/nodejs/node/commit/abc9a069d4)] - **tools**: remove stray package-lock.json file (Rich Trott) [#14873](https://github.com/nodejs/node/pull/14873)
* [[`c9f17ae34b`](https://github.com/nodejs/node/commit/c9f17ae34b)] - **tools**: fix update-eslint.sh (Myles Borins) [#14850](https://github.com/nodejs/node/pull/14850)
* [[`a113b6bd67`](https://github.com/nodejs/node/commit/a113b6bd67)] - **tools**: delete an unused argument (phisixersai) [#14251](https://github.com/nodejs/node/pull/14251)
...
* [[`6903ea4a92`](https://github.com/nodejs/node/commit/6903ea4a92)] - **tracing**: Update to use new Platform tracing apis (Matt Loring) [#14001](https://github.com/nodejs/node/pull/14001)
* [[`a20142da8c`](https://github.com/nodejs/node/commit/a20142da8c)] - **url**: remove unused code from autoEscapeStr (Cyril Lakech) [#15086](https://github.com/nodejs/node/pull/15086)
* [[`ac54624288`](https://github.com/nodejs/node/commit/ac54624288)] - **util**: remove duplicate code in format (Anatoli Papirovski) [#15098](https://github.com/nodejs/node/pull/15098)
* [[`25833a5b60`](https://github.com/nodejs/node/commit/25833a5b60)] - **util**: fix inspect array w. negative maxArrayLength (Ruben Bridgewater) [#14880](https://github.com/nodejs/node/pull/14880)
* [[`e97f7f3435`](https://github.com/nodejs/node/commit/e97f7f3435)] - **util**: use proper circular reference checking (Anna Henningsen) [#14790](https://github.com/nodejs/node/pull/14790)
